      ...
      <nav className="px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">CatCare</span>
          </div>
          <div className="flex items-center space-x-4">
            <button
              onClick={() => setIsSignUp(false)}
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                !isSignUp ? 'bg-orange-600 text-white' : 'text-gray-600 hover:text-orange-600'
              }`}
            >
              Sign In
            </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Easy reminder setup for all your cat care needs</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Timely Notifications</h3>
                  <p className="text-sm text-gray-600">Get reminded when it's time for feeding or meds</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Monitor your cat's health and vet appointments</p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              />
              <div className="p-4">
                <p className="text-sm text-gray-600 text-center">Luna</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img 
              ...
              />
              <div className="p-4">
                <p className="text-sm text-gray-600 text-center">Shadow</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img 
              ...
              />
              <div className="p-4">
                <p className="text-sm text-gray-600 text-center">Whiskers</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img 
              ...
              />
              <div className="p-4">
                <p className="text-sm text-gray-600 text-center">Mittens</p>
              </div>
            </div>
          </div>
        </div>
